...
@pytest.mark.parametrize("persona_id,text", [
    ...
    ("P-W-POL", "Fuer meinen Wahlkreis brauche ich Zahlen zur Digitalisierung."),
    ("P-W-POL", "Als Politikerin moechte ich eine parlamentarische Anfrage stellen."),
...
def test_all_personas_present():
    ...
    expected = {
        ...
        "P-W-PRESSE", "P-W-POL", "P-VER", "P-BER", "P-AND",
    }
