...
async def get_elements():
    ...
    # Personas
    personas = []
    # Welle E (2026-05): P-W-POL in P-VER gemerged. Slug "pol" bleibt nur
    # für die alte (deprecated) pol.md im Repo, wird aber vom Loader
    # ignoriert (kein id-Frontmatter mehr).
    persona_map = {
        "P-W-LK": "lk", "P-W-SL": "sl", "P-W-PRESSE": "presse",
