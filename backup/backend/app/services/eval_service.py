...
_PERSONA_MARKERS: dict[str, list[str]] = {
    "P-W-LK": [
        # ── Direkte Selbstbezeichnung
        "als lehrkraft", "als lehrerin", "als lehrer",
        # ── Klassen-Possessive (alle Flexionsformen)
        "meine klasse", "meiner klasse", "meinen klassen", "in meiner klasse",
        "fuer die klasse", "für die klasse",
        # ── Unterricht-Possessive
        "mein unterricht", "meinen unterricht", "meines unterrichts",
        "im unterricht", "für den unterricht", "fuer den unterricht",
        "für meinen unterricht", "fuer meinen unterricht",
        # ── Unterrichts-Komposita
        "unterrichtsentwurf", "unterrichtsstunde", "unterrichtsplanung",
        "unterrichtsmaterial", "unterrichtseinheit", "unterrichtseinstieg",
        "stundenentwurf", "stundenplanung", "stundenbild", "doppelstunde",
        # ── Klassen-Stufen (alle 1–13, plus "klasse N")
        "in klasse 1", "in klasse 2", "in klasse 3", "in klasse 4",
        "in klasse 5", "in klasse 6", "in klasse 7", "in klasse 8",
        "in klasse 9", "in klasse 10", "in klasse 11", "in klasse 12", "in klasse 13",
        "für klasse 1", "für klasse 2", "für klasse 3", "für klasse 4",
        "für klasse 5", "für klasse 6", "für klasse 7", "für klasse 8",
        "für klasse 9", "für klasse 10", "für klasse 11", "für klasse 12",
        "fuer klasse 5", "fuer klasse 6", "fuer klasse 7", "fuer klasse 8",
        "fuer klasse 9", "fuer klasse 10",
        "klassen 5-7", "klassen 7-10", "klassen 8-10",
        "5. klasse", "6. klasse", "7. klasse",  # ambivalent w/ SL, aber siehe Ausschluss unten
        # ── Lehrplan / Curriculum / Bildungsstufen
        "lehrplan", "curriculum", "kerncurriculum", "bildungsstandards",
        "klassenarbeit", "klassenarbeiten", "leistungsbeurteilung",
        "sek i", "sek ii", "sekundarstufe",
        # ── Didaktik-Termini
        "lernziel", "lernziele", "kompetenzraster", "didaktisch",
        "lernergebnis", "differenzierung", "binnendifferenzierung",
    ],
    "P-W-SL": [
        # ── Direkte Selbstbezeichnung
        "als schuelerin", "als schülerin", "als schueler", "als schüler",
        # ── Wendungen aus dem Schüler-Sprachgebrauch
        "ich verstehe nicht", "ich verstehe das nicht", "verstehe das nicht",
        "ich verstehe das thema", "ich verstehe nicht so gut",
        "ich check", "ich check das nicht", "ich kapier", "ich kapiere",
        "ich rafft", "ich raffe", "kapiere nicht",
        # ── Hausaufgaben / Klausur / Test / Prüfung
        "hausaufgabe", "hausaufgaben", "meine hausaufgabe", "meine hausaufgaben",
        "fuer meine hausaufgabe", "für meine hausaufgabe",
        "meine mathe-hausaufgaben", "meine mathehausaufgaben",
        "klausur", "meine klausur", "fuer meine klausur", "für meine klausur",
        "meine pruefung", "meine prüfung", "fuer meine pruefung", "für meine prüfung",
        "test", "fuer meinen test", "für meinen test", "klassentest",
        "fuer meine mathe-aufgabe", "für meine mathe-aufgabe", "matheaufgabe",
        "matheaufgaben", "meine matheaufgabe", "meine matheaufgaben",
        "die matheaufgaben",
        # ── Klassen-Stufen aus Schüler-Perspektive
        "in meiner 5. klasse", "in meiner 6. klasse", "in meiner 7. klasse",
        "in meiner 8. klasse", "in meiner 9. klasse", "in meiner 10. klasse",
        "in meiner 11. klasse", "in meiner 12. klasse", "in meiner 13. klasse",
        "in der 5. klasse", "in der 6. klasse", "in der 7. klasse",
        "in der 8. klasse", "in der 9. klasse", "in der 10. klasse",
        "in der 11. klasse", "in der 12. klasse", "in der 13. klasse",
        "ich bin in der", "ich gehe in die",
        "fuer meinen jahrgang", "für meinen jahrgang",
        # ── Schul-Kontext
        "in der schule", "auf der schule", "auf meine schule",
        "schulstoff", "lernstoff", "schulalltag",
        "leistungskurs", "grundkurs", "lk physik", "lk mathe", "lk deutsch",
        "abi", "abitur", "abiprüfung", "abivorbereitung",
        "vorm abi", "fuers abi", "fürs abi",
        # ── Lehrer-Erwähnung aus Schüler-Sicht
        "meine lehrerin sagt", "mein lehrer sagt", "meine lehrerin hat gesagt",
        "mein lehrer hat gesagt", "unsere lehrerin", "unser lehrer",
        # ── Typische SuS-Frage-Eröffnungen
        "kannst du mir helfen bei", "kannst du mir das erklären",
    ...
    # Welle E (2026-05-17): P-W-POL wurde in P-VER gemerged.  Die
    # ehemals separaten Politik-Marker sind unten in P-VER eingegliedert.
    "P-VER": [
        # Verwaltungs-Marker
        ...
        "kpi",
        # ── Politik-Marker (ehemals P-W-POL, Welle E gemerged) ───
        "fuer meinen wahlkreis", "für meinen wahlkreis", "als politiker",
        "als politikerin", "als abgeordnete", "als abgeordneter",
        "bildungspolitik", "bildungspolitisch", "parlamentarische anfrage",
        "fuer die fraktion", "für die fraktion",
        "fuer einen antrag", "für einen antrag", "plenarsitzung",
        "im plenum", "in der anhoerung", "in der anhörung",
        "positionspapier", "fuer den ausschuss", "für den ausschuss",
    ...
    for p in personas:
        for i in intents:
            ...
            try:
                ...
                # Persona-Marker quality gate (Block 1 — Sprint 6, Welle D update):
                # Check if the LLM-generated opening contains a persona anchor.
                #
                # Mode "strict": drop missing-marker openings (legacy behavior).
                # Mode "warn":   keep all, just log misses for telemetry.  This
                #                is the new default — strict was losing >80% of
                #                generated openings because the marker lists
                #                only covered exact phrases, not flexion forms.
                # Mode "off":    skip the check entirely (e.g. cross-persona runs).
                pid = p.get("id", "")
                try:
                    from app.services.config_loader import load_eval_setup_config
                    gate_mode = load_eval_setup_config().get("persona_marker_gate", "warn")
                except Exception:
                    gate_mode = "warn"

                if gate_mode == "off":
                    pass  # accept all generated lines verbatim
                else:
                    kept_lines: list[str] = []
                    dropped: list[str] = []
                    for ln in lines:
                    ...
                    if dropped:
                        logger.info(
                            "Persona-Marker gate [%s] flagged %d/%d openings for %s/%s "
                    ...
                    if gate_mode == "strict":
                        lines = kept_lines
                    # warn mode: keep all lines, the log entry is the signal
...
async def generate_cross_persona_scenarios(
    personas: list[dict], intents: list[dict],
    count_per_combo: int = 2,
    progress_cb: Any = None,
) -> list[dict]:
    """Generate openings for the curated cross-persona combos (Welle D addon).

    Reads ``01-base/cross-persona-scenarios.yaml`` to get a list of atypical
    persona × intent pairs.  Generates ``count_per_combo`` openings per pair
    via the LLM-simulator, marks each scenario with ``is_cross_persona=True``,
    and attaches the YAML ``description`` + ``expected_behavior`` so the judge
    can consider them when scoring.

    Returns a flat list of scenario dicts in the same shape as
    :func:`generate_scenarios`, plus the extra fields.
    """
    ...
    if not combos:
        logger.info("Cross-persona scenarios: no combos configured.")
        return []

    persona_by_id = {p.get("id"): p for p in personas}
    intent_by_id = {i.get("id"): i for i in intents}
    ...
    for combo in combos:
        ...
        iid = combo.get("intent_id", "")
        p = persona_by_id.get(pid)
        i = intent_by_id.get(iid)
        if p is None or i is None:
            logger.warning(
                "Cross-persona combo %s × %s skipped: persona or intent missing.",
                pid, iid,
            )
            continue
        if progress_cb is not None:
            try:
                await progress_cb(combo_idx, total_combos, pid, iid)
            except Exception:
                pass
        # We deliberately reuse the standard scenario prompt — the persona/intent
        # mismatch IS the test.  The extra description goes into a separate user
        # hint message so the simulator stays anchored to the persona's voice.
        prompt = _SCENARIO_PROMPT.format(
            count=count_per_combo,
            persona_label=p.get("label", p.get("id", "")),
            persona_desc=p.get("description", ""),
        ...
        extra = combo.get("description") or ""
        if extra:
            prompt = (
                prompt
                + "\n\nKontext zur untypischen Kombination:\n"
                + extra
                + "\n\nGeneriere die Eröffnungen so, dass sie das oben beschriebene"
                " Anliegen widerspiegeln — aber in der Stimme/Sprache der Persona."
            )
        try:
            resp = await client.chat.completions.create(
                model=DEFAULT_SIMULATOR_MODEL,
            ...
            candidates: list[str] = []
            for ln in raw.split("\n"):
                ln = ln.strip().strip('"').strip("'").lstrip("-•*").strip()
                if len(ln) > 2 and ln[0].isdigit():
                    for sep in (". ", ") ", ": ", "- "):
                        if sep in ln[:5]:
                            ln = ln.split(sep, 1)[1].strip()
                ...
                if ln and len(ln) >= 8:
                    candidates.append(ln)
            lines = candidates[:count_per_combo]
            # Persona-Marker gate respektiert denselben Mode wie generate_scenarios.
            # Bei "off" oder "warn" werden alle Openings beibehalten — bei
            # untypischen Combos ist Strict-Drop besonders schmerzhaft, weil
            # diese Combos eh seltener "klare" Marker erzeugen.
            try:
                from app.services.config_loader import load_eval_setup_config
                gate_mode_cp = load_eval_setup_config().get("persona_marker_gate", "warn")
            except Exception:
                gate_mode_cp = "warn"
            ...
            if gate_mode_cp == "off":
                ...
                kept_lines_raw = [ln for ln in lines if _has_persona_marker(ln, pid)]
                if len(kept_lines_raw) < len(lines):
                    logger.info(
                        "Persona-Marker gate [%s, cross-persona] flagged %d/%d "
                        "for %s × %s",
                        gate_mode_cp,
                        len(lines) - len(kept_lines_raw), len(lines), pid, iid,
                    )
                kept_lines = (
                    kept_lines_raw if gate_mode_cp == "strict" else lines
                )
            for idx, line in enumerate(kept_lines):
                scenarios.append({
                    ...
                    "opening": line,
                    "index": idx,
                    # Marker für Aggregator + Judge.
                    "is_cross_persona": True,
                    "cross_persona_description": combo.get("description", ""),
                    "cross_persona_expected": combo.get("expected_behavior", ""),
                })
        except Exception as e:
            logger.warning(
                "Cross-persona scenario gen failed for %s × %s: %s",
                pid, iid, e,
            )
    logger.info(
        "Generated %d cross-persona scenarios across %d combos.",
        len(scenarios), len(combos),
    )
    return scenarios
...
async def _post_chat(
    ...
    pattern_selection_mode: str | None = None,
) -> dict[str, Any]:
    ...
    ``pattern_selection_mode`` (Welle D Sprint 2) wird in den
    ``environment``-Block der ChatRequest gehängt — None = YAML-Default.
    Eval-Runner setzt das auf "llm_hint_authoritative" für A/B-Runs.
    """
    if not session_id:
...
# ── Re-Judge for LLM-Hint vs Engine (Welle D Shadow-A/B addon) ────────
#
# Wir wollen direkt messen, ob das Regelsystem (Engine) oder der LLM-
# Hint-Classifier besser performt — heute messen wir nur eine Lower-Bound
# (Cases wo beide übereinstimmen).  Statt einen zweiten Bot-Run zu
# starten (doppelt teuer), fragen wir den Judge in einem dedizierten
# Prompt nach einer **Forced-Choice**: A (Engine) oder B (LLM-Hint).
# Das ist eine objektive Pattern-Eignung-Bewertung, unabhängig davon,
# was der Bot tatsächlich geantwortet hat.

_REJUDGE_PROMPT = """Du bist ein Pattern-Experte fuer einen WLO-Bildungs-Chatbot.

Der Bot hat zwei Mechanismen, die Patterns auswaehlen: ein deterministisches
Regelsystem (Engine) und ein LLM-Klassifikator-Hint. Beide entschieden sich fuer
unterschiedliche Patterns. Du bewertest, welches in diesem Fall objektiv besser
gewesen waere — unabhaengig davon, was der Bot tatsaechlich geantwortet hat.

Nutzer-Persona: {persona_label} — {persona_desc}
Nutzer-Nachricht:
{user_msg}

Die Bot-Antwort (Kontext):
{bot_response}

Patterns zur Auswahl:

Pattern A (Engine-Entscheidung):
ID: {engine_pattern_id}
Label: {engine_pattern_label}

Pattern B (LLM-Hint):
ID: {llm_hint_id}
Label: {llm_hint_label}

Welches Pattern waere fuer diese Nutzer-Nachricht objektiv besser geeignet?
- "A" wenn Pattern A klar besser passt.
- "B" wenn Pattern B klar besser passt.
- "tie" wenn beide gleich gut waeren (selten — vermeide "tie", wenn ein Pattern
  auch nur einen kleinen Vorteil hat).

Zusaetzlich gib fuer jedes Pattern unabhaengig einen Eignungs-Score (0=schlecht,
1=mittel, 2=gut). 0/2 + 2/2 ist ein klares B-Plaedoyer; 2/2 + 1/2 ein A-Plaedoyer
mit knapper Mehrheit.

Gib NUR ein JSON-Objekt zurueck:
{{"preferred": "A" | "B" | "tie",
  "preferred_pattern_id": "{engine_pattern_id}" | "{llm_hint_id}",
  "engine_pattern_fit": 0-2,
  "llm_hint_pattern_fit": 0-2,
  "reasoning": "<1-2 Saetze, max 200 Zeichen>"}}
"""


async def judge_pattern_choice(
    persona: dict, user_msg: str, bot_response: str,
    engine_pattern_id: str, engine_pattern_label: str,
    llm_hint_id: str, llm_hint_label: str,
) -> dict[str, Any]:
    """Forced-choice judge call comparing Engine pattern vs LLM-Hint.
    ...
    Returns dict with::

        {
            ...
            "engine_pattern_fit": int (0-2),
            "llm_hint_pattern_fit": int (0-2),
            "reasoning": str,
        }

    On error / parse failure, returns empty dict — the aggregator treats
    that as "skip this turn".  Only triggered when engine != llm_hint;
    otherwise no value in re-judging.
    """
    if not engine_pattern_id or not llm_hint_id:
        return {}
    if engine_pattern_id == llm_hint_id:
        return {}
    client = get_client()
    prompt = _REJUDGE_PROMPT.format(
        persona_label=persona.get("label", ""),
        persona_desc=(persona.get("description") or "")[:200],
        user_msg=user_msg[:600],
        bot_response=bot_response[:1000],
        engine_pattern_id=engine_pattern_id,
        engine_pattern_label=engine_pattern_label or "",
        llm_hint_id=llm_hint_id,
        llm_hint_label=llm_hint_label or "",
    )
    try:
        resp = await client.chat.completions.create(
        ...
        logger.warning("Pattern-choice judge failed: %s", e)
        return {}

    preferred = str(data.get("preferred", "")).upper().strip()
    if preferred not in ("A", "B", "TIE"):
        preferred = "TIE"  # safe default
    # Coerce fit scores
    def _clamp(v, lo=0, hi=2):
        try:
            return max(lo, min(hi, int(v)))
        except Exception:
            return 0
    return {
        "preferred": preferred.lower() if preferred == "TIE" else preferred,
        "preferred_pattern_id": str(data.get("preferred_pattern_id", "")).strip(),
        "engine_pattern_fit": _clamp(data.get("engine_pattern_fit", 0)),
        "llm_hint_pattern_fit": _clamp(data.get("llm_hint_pattern_fit", 0)),
...
def _aggregate_classification_metrics(
    ...
    # Tie-Breaker (Bonus 2 / Welle D Shadow-A/B) — wie oft hat der LLM-Hint
    # den Engine-Winner überstimmt (live), und in welchen Pattern-Clustern
    # WÜRDE er es im Shadow-Modus tun?
    # Liest ``debug.phase3_modulations.tie_breaker`` (geschrieben in chat.py).
    tie_breaker_applied = 0           # would_apply AND mode == "live"
    tie_breaker_evaluated = 0         # any case where tie-breaker considered
    tie_breaker_would_apply = 0       # would_apply (shadow+live combined)
    tie_breaker_overrides: dict[str, int] = {}        # live: "FROM->TO" → count
    tie_breaker_would_overrides: dict[str, int] = {}  # shadow: "FROM->TO" → count

    # Persona-Loosening (Welle D Shadow-A/B) — Counterfactual ohne persona-
    # typische Trait-Signals. Zeigt, wie stark Persona-Traits aktuell die
    # Pattern-Wahl beeinflussen.
    persona_loosening_evaluated = 0           # Traits in signals → Counterfactual computed
    persona_loosening_would_change = 0        # Counterfactual-Winner ≠ Live-Winner
    persona_loosening_applied = 0             # mode == "live" AND winner changed
    persona_loosening_would_changes: dict[str, int] = {}  # "FROM->TO" → count

    # Cross-Persona-Scenarios (Welle D addon) — separater Score-Block für
    # untypische Persona×Intent-Combos. Misst, ob das System bei Edge-Cases
    # zusammenbricht oder sinnvoll antwortet.
    cross_persona_judged_turns = 0
    cross_persona_score_sum = 0.0
    cross_persona_engine_judge_ok = 0    # pattern_match >= 2 auf cross-persona-turns
    cross_persona_intent_correct = 0
    cross_persona_intent_total = 0
    cross_persona_persona_correct = 0
    cross_persona_persona_total = 0
    cross_persona_pattern_usage: dict[str, int] = {}

    # Strategy-Showdown (Welle D addon) — Re-Judge-Forced-Choice zwischen
    # Engine und LLM-Hint, wenn beide unterschiedlich. Direkter Vergleich
    # der zwei Pattern-Auswahl-Strategien (Regelsystem vs LLM-Klassifikator).
    pattern_choice_evaluated = 0       # Anzahl Re-Judge-Calls
    pattern_choice_engine_wins = 0
    pattern_choice_llm_wins = 0
    pattern_choice_ties = 0
    pattern_choice_engine_fit_sum = 0
    pattern_choice_llm_fit_sum = 0
    # Pro Pattern-Disagreement zählen wir Wins für Engine bzw LLM
    pattern_choice_engine_wins_by_pair: dict[str, int] = {}
    pattern_choice_llm_wins_by_pair: dict[str, int] = {}

    # LLM-Hint Authoritative (Welle D Sprint 2) — Telemetrie für den
    # A/B-Run-Modus "llm_hint_authoritative". Zählt, wie oft die Engine
    # umgangen wurde und in wievielen Cases der LLM-Hint Patterns
    # gewählt hat, die der Engine-Gate nicht durchgelassen hätte.
    authoritative_turns = 0
    authoritative_gate_violations = 0
    authoritative_violation_kinds: dict[str, int] = {}  # "persona"/"state"/"intent"/"precondition_slots" → count
    authoritative_pattern_usage: dict[str, int] = {}

    for conv in conversations:
        expected_persona = conv.get("persona_id", "")
        expected_intent = conv.get("intent_id", "")
        # Cross-persona scenarios carry this flag from generate_cross_persona_scenarios.
        # In conversations mode we don't have it (those use the standard combo set);
        # in scenarios mode each conv represents one scenario and inherits the flag.
        is_cross_persona = bool(conv.get("is_cross_persona", False))
        for turn in conv.get("turns", []):
            dbg = turn.get("debug", {}) or {}
            judge = turn.get("judge", {}) or {}
            # judge_pattern_choice is set by execute_run when re-judge is on
            # AND llm_hint != engine_pattern for that turn.
            judge_choice = turn.get("judge_pattern_choice") or {}
            ...
            # ── Cross-Persona-Tracking (Welle D addon) ──
            # Per-Turn-Split: ist diese Konversation ein gezielter Cross-
            # Persona-Test? Dann führen wir parallele Aggregat-Counter, damit
            # man unmittelbar sieht, wie das System auf atypische Combos reagiert.
            if is_cross_persona:
                cross_persona_judged_turns += 1
                # turn-Score = Judge total
                _t = judge.get("total")
                if isinstance(_t, (int, float)):
                    cross_persona_score_sum += float(_t)
                if engine_pattern:
                    cross_persona_pattern_usage[engine_pattern] = (
                        cross_persona_pattern_usage.get(engine_pattern, 0) + 1
                    )
                if pm is not None:
                    try:
                        _pm = int(pm)
                        ...
                        _pm = 0
                    if _pm >= 2:
                        cross_persona_engine_judge_ok += 1
                if expected_persona and actual_persona:
                    cross_persona_persona_total += 1
                    if expected_persona == actual_persona:
                        cross_persona_persona_correct += 1
                if expected_intent and actual_intent:
                    cross_persona_intent_total += 1
                    if expected_intent == actual_intent:
                        cross_persona_intent_correct += 1

            # ── Strategy-Showdown (Welle D addon) ──
            # judge_pattern_choice ist gesetzt, wenn der Re-Judge-Modus
            # aktiv war UND engine_pattern != llm_hint. Ergebnis: Forced-
            # Choice (A=Engine, B=LLM-Hint, tie) plus zwei Eignungs-Scores.
            if judge_choice and judge_choice.get("preferred"):
                pattern_choice_evaluated += 1
                pref = str(judge_choice.get("preferred", "")).upper()
                pair_key = f"{engine_pattern}-vs-{llm_hint}"
                if pref == "A":
                    pattern_choice_engine_wins += 1
                    pattern_choice_engine_wins_by_pair[pair_key] = (
                        pattern_choice_engine_wins_by_pair.get(pair_key, 0) + 1
                    )
                elif pref == "B":
                    pattern_choice_llm_wins += 1
                    pattern_choice_llm_wins_by_pair[pair_key] = (
                        pattern_choice_llm_wins_by_pair.get(pair_key, 0) + 1
                    )
                else:
                    pattern_choice_ties += 1
                try:
                    pattern_choice_engine_fit_sum += int(judge_choice.get("engine_pattern_fit", 0))
                    pattern_choice_llm_fit_sum += int(judge_choice.get("llm_hint_pattern_fit", 0))
                except Exception:
                    pass
            ...
            # Tie-Breaker (Bonus 2 / Welle D) — count overrides + clusters.
            # Live-Modus: applied=true → echter Override.
            # Shadow-Modus: would_apply=true → wäre Override gewesen.
            ...
            if isinstance(tb, dict):
                ...
                if tb.get("would_apply"):
                    tie_breaker_would_apply += 1
                    # ``to_if_live`` (shadow) or ``to`` (live)
                    target = tb.get("to") or tb.get("to_if_live") or "?"
                    edge = f"{tb.get('from', tb.get('engine_winner', '?'))}->{target}"
                    tie_breaker_would_overrides[edge] = (
                        tie_breaker_would_overrides.get(edge, 0) + 1
                    )
                if tb.get("applied"):
            ...
            # Persona-Loosening (Welle D) — Counterfactual-Tracking.
            pl = modulations.get("persona_loosening") if isinstance(modulations, dict) else None
            if isinstance(pl, dict) and pl.get("evaluated"):
                persona_loosening_evaluated += 1
                if pl.get("would_change_winner"):
                    persona_loosening_would_change += 1
                    edge = (
                        f"{pl.get('live_winner', '?')}->{pl.get('counterfactual_winner', '?')}"
                    )
                    persona_loosening_would_changes[edge] = (
                        persona_loosening_would_changes.get(edge, 0) + 1
                    )
                if pl.get("applied"):
                    persona_loosening_applied += 1

            # LLM-Hint Authoritative (Welle D Sprint 2) — Telemetrie.
            ha = modulations.get("llm_hint_authoritative") if isinstance(modulations, dict) else None
            if isinstance(ha, dict) and ha.get("applied"):
                authoritative_turns += 1
                pat = ha.get("pattern_id", "?")
                authoritative_pattern_usage[pat] = (
                    authoritative_pattern_usage.get(pat, 0) + 1
                )
                violations = ha.get("gate_violations") or []
                if violations:
                    authoritative_gate_violations += 1
                    for v in violations:
                        # "persona(...)" / "state(...)" / "intent(...)" / "precondition_slots(...)"
                        kind = v.split("(", 1)[0].strip() if "(" in v else v.strip()
                        if kind:
                            authoritative_violation_kinds[kind] = (
                                authoritative_violation_kinds.get(kind, 0) + 1
                            )
    ...
    return {
        ...
        # Tie-Breaker telemetry (Bonus 2 / Welle D Shadow-A/B).
        # Live + Shadow zusammen — ``would_apply_*`` zählt alle Cases, in
        # denen der Tie-Breaker übergreifen würde (auch im Shadow-Modus),
        # ``applied_*`` nur die echten Overrides.
        "tie_breaker": {
            "evaluated_turns": tie_breaker_evaluated,
            "would_apply_count": tie_breaker_would_apply,
            "would_apply_rate": (
                round(tie_breaker_would_apply / tie_breaker_evaluated, 3)
                if tie_breaker_evaluated else 0.0
            ),
            "would_overrides": tie_breaker_would_overrides,
        ...
        # Persona-Loosening telemetry (Welle D Shadow-A/B).
        # Counterfactual-Score ohne persona-typische Trait-Signals.
        "persona_loosening": {
            "evaluated_turns": persona_loosening_evaluated,
            "would_change_count": persona_loosening_would_change,
            "would_change_rate": (
                round(persona_loosening_would_change / persona_loosening_evaluated, 3)
                if persona_loosening_evaluated else 0.0
            ),
            "would_changes": persona_loosening_would_changes,
            "applied_count": persona_loosening_applied,
            "applied_rate": (
                round(persona_loosening_applied / persona_loosening_evaluated, 3)
                if persona_loosening_evaluated else 0.0
            ),
        },
        # Cross-Persona-Aggregate (Welle D addon) — separater Score-Block
        # für die kuratierten untypischen Combos.  Wenn der Run KEINE
        # cross-persona-Szenarien hat, sind alle Zähler 0 — das Studio-UI
        # blendet den Block dann aus.
        "cross_persona": {
            "judged_turns": cross_persona_judged_turns,
            "avg_score": (
                round(cross_persona_score_sum / cross_persona_judged_turns, 3)
                if cross_persona_judged_turns else 0.0
            ),
            "engine_pattern_judge_ok_count": cross_persona_engine_judge_ok,
            "engine_pattern_judge_ok_rate": (
                round(cross_persona_engine_judge_ok / cross_persona_judged_turns, 3)
                if cross_persona_judged_turns else 0.0
            ),
            "persona_correct_rate": (
                round(cross_persona_persona_correct / cross_persona_persona_total, 3)
                if cross_persona_persona_total else 0.0
            ),
            "intent_correct_rate": (
                round(cross_persona_intent_correct / cross_persona_intent_total, 3)
                if cross_persona_intent_total else 0.0
            ),
            "pattern_usage": cross_persona_pattern_usage,
        },
        # LLM-Hint Authoritative (Welle D Sprint 2) — A/B-Modus-Telemetrie.
        # Wenn der Run mit pattern_selection_mode="llm_hint_authoritative"
        # gelaufen ist, zeigt dieser Block:
        #   * wie viele Turns LLM-only entschieden haben,
        #   * wie oft das gewählte Pattern Engine-Gates verletzt hätte,
        #   * welche Gate-Arten (persona/state/intent/precondition_slots)
        #     am häufigsten überflogen wurden,
        #   * welche Patterns dieser Modus am häufigsten gewählt hat.
        # Wenn der Run im Engine-Modus lief, sind alle Werte 0.
        "llm_hint_authoritative": {
            "evaluated_turns": authoritative_turns,
            "gate_violation_count": authoritative_gate_violations,
            "gate_violation_rate": (
                round(authoritative_gate_violations / authoritative_turns, 3)
                if authoritative_turns else 0.0
            ),
            "violation_kinds": authoritative_violation_kinds,
            "pattern_usage": authoritative_pattern_usage,
        },
        # Strategy-Showdown (Welle D addon) — Re-Judge-Vergleich
        # Engine-Pattern vs LLM-Hint bei Disagreement-Turns.  Direkte
        # Antwort auf: "Was performt besser — Regelsystem oder LLM-Hint?"
        "strategy_showdown": {
            "evaluated_turns": pattern_choice_evaluated,
            "engine_wins": pattern_choice_engine_wins,
            "llm_hint_wins": pattern_choice_llm_wins,
            "ties": pattern_choice_ties,
            "engine_win_rate": (
                round(pattern_choice_engine_wins / pattern_choice_evaluated, 3)
                if pattern_choice_evaluated else 0.0
            ),
            "llm_hint_win_rate": (
                round(pattern_choice_llm_wins / pattern_choice_evaluated, 3)
                if pattern_choice_evaluated else 0.0
            ),
            "engine_avg_fit": (
                round(pattern_choice_engine_fit_sum / pattern_choice_evaluated, 3)
                if pattern_choice_evaluated else 0.0
            ),
            "llm_hint_avg_fit": (
                round(pattern_choice_llm_fit_sum / pattern_choice_evaluated, 3)
                if pattern_choice_evaluated else 0.0
            ),
            "engine_wins_by_pair": pattern_choice_engine_wins_by_pair,
            "llm_hint_wins_by_pair": pattern_choice_llm_wins_by_pair,
        },
    }
...
def _compute_target_turns(
    ...
    include_cross_persona: bool = False,
) -> int:
    ...
    With ``include_cross_persona=True`` we add the cross-persona combos
    from the YAML to the scenarios estimate (only valid for modes that
    include scenarios — the cross-persona stage is scenarios-only)."""
    combos = n_personas * n_intents
    ...
    cp_turns = 0
    if include_cross_persona and mode in ("scenarios", "both"):
        try:
            from app.services.config_loader import load_cross_persona_scenarios
            cp_combos = len(load_cross_persona_scenarios().get("combos", []))
            cp_turns = cp_combos * scenarios_per_combo
        except Exception:
            cp_turns = 0
    return scen_turns + conv_turns + cp_turns
...
async def execute_run(
    ...
    config_slug: str = "",
    include_cross_persona: bool = False,
    enable_pattern_rejudge: bool = False,
    pattern_selection_mode: str | None = None,
) -> None:
    ...
    target_turns = _compute_target_turns(
        ...
        include_cross_persona=include_cross_persona,
    )
    ...
    # Pattern-Label-Lookup für den Re-Judge (Welle D addon).  Cached vor dem
    # Loop, damit jeder Re-Judge-Call die Labels schnell zur Hand hat.
    pattern_labels: dict[str, str] = {}
    if enable_pattern_rejudge:
        try:
            from app.services.config_loader import load_pattern_definitions as _lp
            for p in _lp() or []:
                pid = p.get("id")
                if pid:
                    pattern_labels[pid] = p.get("label", "") or ""
        except Exception as _le:
            logger.warning("[eval %s] pattern label lookup failed: %s", run_id, _le)

    async def _maybe_rejudge(persona: dict, user_msg: str, bot_text: str,
                             dbg: dict) -> dict[str, Any]:
        """Run the pattern-choice re-judge if enabled AND hint != engine.

        Returns the choice dict or {} if not applicable.  Failure modes
        (LLM error, missing IDs) return {} silently — the aggregator
        simply skips those turns.
        """
        if not enable_pattern_rejudge:
            return {}
        engine_pid = _strip_id(dbg.get("pattern", ""))
        hint_pid = (dbg.get("pattern_id_hint") or "").strip()
        if not engine_pid or not hint_pid or engine_pid == hint_pid:
            return {}
        try:
            return await judge_pattern_choice(
                persona=persona,
                user_msg=user_msg,
                bot_response=bot_text,
                engine_pattern_id=engine_pid,
                engine_pattern_label=pattern_labels.get(engine_pid, ""),
                llm_hint_id=hint_pid,
                llm_hint_label=pattern_labels.get(hint_pid, ""),
            )
        except Exception as _re:
            logger.warning("[eval %s] re-judge failed: %s", run_id, _re)
            return {}
    ...
    try:
        ...
        if mode in ("scenarios", "both"):
            ...
            # Welle D addon — kuratierte Cross-Persona-Combos zusätzlich
            # zur regulären Persona×Intent-Matrix.  Setzt is_cross_persona=True
            # in jedem generierten Scenario, damit der Aggregator danach
            # einen separaten Score-Block ausweisen kann.
            if include_cross_persona:
                cp_scens = await generate_cross_persona_scenarios(
                    personas, intents, scenarios_per_combo,
                    progress_cb=_scenario_progress,
                )
                logger.info(
                    "[eval %s] generated %d cross-persona scenarios",
                    run_id, len(cp_scens),
                )
                scens.extend(cp_scens)
            for idx, sc in enumerate(scens):
                ...
                try:
                    ...
                    judge_choice = await _maybe_rejudge(
                        persona, sc["opening"], bot_text, dbg_flat,
                    )
                except Exception as e:
                ...
                conversations.append({
                    ...
                    # Welle D: aus generate_cross_persona_scenarios propagiert.
                    "is_cross_persona": bool(sc.get("is_cross_persona", False)),
                    "cross_persona_description": sc.get("cross_persona_description", ""),
                    "cross_persona_expected": sc.get("cross_persona_expected", ""),
                    "session_id": None,
                    "turns": [{
                        "user": sc["opening"],
                        "bot": bot_text,
                        "debug": dbg_flat,
                        "judge": judge,
                        # Welle D: Re-Judge-Result für Strategy-Showdown.
                        # Leer {} wenn engine == hint oder Re-Judge aus.
                        "judge_pattern_choice": judge_choice,
                    }],
                })
                ...
                for intent in intents:
                    ...
                    try:
                        conv = await simulate_conversation(
                            persona, intent, max_turns=turns_per_conv,
                            pattern_selection_mode=pattern_selection_mode,
                        )
                    except Exception as e:
                    ...
                    for turn in conv["turns"]:
                        ...
                        # Welle D — Re-Judge bei Pattern-Disagreement (no-op
                        # if disabled or engine == hint).
                        turn["judge_pattern_choice"] = await _maybe_rejudge(
                            persona, turn["user"], turn["bot"], turn["debug"],
                        )
                    conversations.append({
                        "kind": "conversation",
        ...
        # Welle D Sprint 2: Den verwendeten Pattern-Selection-Modus
        # in die Summary schreiben, damit das Studio den Run sofort als
        # "Engine-Run" oder "LLM-Hint-Run" kennzeichnen kann.
        summary["pattern_selection_mode"] = pattern_selection_mode or "engine"
