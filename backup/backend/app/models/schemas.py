...
class Environment(BaseModel):
    ...
    # ── Pattern-Selection-Modus (Welle D Sprint 2) ──
    # Per-Request-Override für die Pattern-Auswahl-Strategie. Erlaubte Werte:
    #   * "engine" — klassisches 3-Phasen-Routing
    #   * "engine_with_hint_tiebreaker" — Alias (Verhalten = engine)
    #   * "llm_hint_authoritative" — LLM-Hint überschreibt Engine (Diagnostik)
    # None = nutze YAML-Default aus 01-base/pattern-selection.yaml.
    # Wird vom Eval-Runner gesetzt für A/B-Vergleichs-Runs.
